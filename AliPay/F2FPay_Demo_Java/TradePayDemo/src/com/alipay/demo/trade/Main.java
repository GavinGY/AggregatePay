...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String authCodeT1 = null;
        authCodeT1 = readTxt(filePath);
        System.out.println("authCodeT1:" + authCodeT1);
        main.test_trade_pay(tradeService,authCodeT1);
    ...
    public void test_monitor_schedule_logic() {
        ...
        while (Math.random() != 0) {
            test_trade_pay(tradeWithHBService,"1");
            Utils.sleep(5 * 1000);
        }
	  ...
	  try {
	    ...
	    if(file.isFile() && file.exists()) {
	      ...
	      while ((lineTxt = br.readLine()) != null) {//使用readLine方法，一次读一行
	        ...
	        result.append(lineTxt);//result.append(System.lineSeparator()+lineTxt);
	      }
	      br.close();
	    } else {
    ...
    // 测试当面付2.0支付
    public void test_trade_pay(AlipayTradeService service,String authCodeT) {
        ...
        // String authCode = "286204121426920455"; // 条码示例，286648048691290423 用户自己的支付宝付款码
        String authCode = authCodeT;
        ...
        String sellerId = "2088102176526440";  //沙箱测试的商家UID
